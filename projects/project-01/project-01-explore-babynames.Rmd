...
Begin by computing the distribution of births across year and sex by last letter of a name.

```{r question-3-bonus-transform-2}
...
```{r question-3-bonus-visualize-1}
tbl_names_by_last_letter |> 
  # Filter for the year 2020
   filter(year == 2020) |>
  # Initialize a ggplot of pct_births vs. first_letter
...
```{r question-3-bonus-visualize-2}
