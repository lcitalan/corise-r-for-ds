...
tbl_names_female_top_25 <- tbl_names |>
  ...
  #arrange by nb_births to get the most common
...
tbl_names_extended_age |> 
  ...
  # Add labels (title, subtitle, x, y)
  labs(
    title = "Median Age for Women with the 25 most common names in US",
    subtitle = "Estimated to be alive in 2022",
    x = "Median Age",
    y = "Name"
  ) +
